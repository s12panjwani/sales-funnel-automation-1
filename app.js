...
let MOCK_EMAILS = [
  {
    id: 'E001',
    from: 'joint-planning@ops.in',
    sender: 'Operators Joint Planning Group',
    operator: 'Jio',
    subject: 'Urgent Pending 420 Upgrade Sites RFIP Sign-Off Request',
    time: '2026-05-27 11:15',
    priority: 'high',
    unread: true,
    body: `Dear Sir,
Request you to please provide the below pending 420 upgrade sites RFIB sign off urgently, as pending since long.

| Project Name | 0-30 | 31-60 | 61-90 | 91-180 | > 180 days | Grand Total |
|---|---|---|---|---|---|---|
| 5G | | | | | 4 | 4 |
| Airfiber_A6 | | | 3 | | 83 | 86 |
| MW | 246 | 17 | 16 | 10 | 40 | 329 |
| RRH Swap | | | | | 1 | 1 |
| Grand Total | 246 | 17 | 19 | 10 | 128 | 420 |

Best Regards,
Joint Operations Planning Group
National Portal Team`,
    extracted: {
  ...
  {
    id: 'E002',
    from: 'rjio.planning@jio.com',
    sender: 'Jio Operator Planning',
    operator: 'Airtel',
    subject: 'JIO SO Issuance – 7 Feasibility-Received Sites (SAP ID I-UW-KAIR-ENB-A002 etc.)',
    time: '2026-05-27 10:45',
    priority: 'high',
    unread: true,
    body: `Dear Anuj Ji,
Pl consider this mail as SO issuance of below 7 sites as per feasibility received.
4 Sites are on hold due to rent hike issue.

| Rjio SAP ID | ATC ID | Site wise sector count | New Azimuth | Antenna height | Required no of MW | MW Dia | MW height | RF Antenna Massive MIMO | RRU | Additional DC Power - 48Volt | Additional MCBs for DC Power Tapping |
|---|---|---|---|---|---|---|---|---|---|---|---|
| I-UW-KAIR-ENB-A002 | UPW/AL/RJ/16633 | 2 sector | 205/325 | 41/41 | | | | 2 | 2 | 2.5KW | 2x63A |
| I-UW-MDBD-ENB-A002 | UPW/MO/TT/13243 | 2 sector | 45/165 | 40/40 | | | | 2 | 2 | 2.5KW | 2x63A |
| I-UW-MTHR-ENB-A003 | UPW/MA/RJ/16502 | 2 sector | 60/230 | 41/41 | | | | 2 | 2 | 2.5KW | 2x63A |
| I-UW-MTHR-ENB-A006 | UPW/MA/RJ/16503 | 2 sector | 80/210 | 41/41 | 1 | 0.6 | 38 | 2 | 2 | 2.5KW | 2x63A |
| I-UW-SUAR-ENB-A002 | UPW/RM/ID/11158 | 2 sector | 150/325 | 37/37 | 1 | 0.6 | 38 | 2 | 2 | 2.5KW | 2x63A |
| I-UW-DNUR-ENB-A003 | UPW/JY/ID/11084 | 2 sector | 120/250 | 40/40 | 1 | 0.6 | 38 | 2 | 2 | 2.5KW | 2x63A |
| I-UW-SMBL-ENB-A006 | UPW/MO/TT/13013 | 2 sector | 0/170 | 40/40 | | | | 2 | 2 | 2.5KW | 2x63A |

Best Regards,
Airtel Operations Desk`,
    extracted: {
      ...
      tenantInfo: { val: '7 Sites SO Issuance', conf: 96 },
  ...
  {
    id: 'E003',
    from: 'beant.singh@atcindia.in',
    sender: 'Beant Singh',
    operator: 'Vi',
    subject: 'ATC Shared Relocation Nominal – AMR7723 Field Survey Alignment',
    time: '2026-05-27 10:12',
    priority: 'high',
    unread: true,
    body: `Dear Sumeet Sir,

As Per Our Discussion, Our existing AMR7723 site against ATC shared relocation nominal is ok and the team to be aligned for field survey.will be confirmed after field survey

As per earlier, ATC provided 12 Mtrs Pole but now the same location provides 9 Mtrs Pole. if possible try for a minimum 12 mtrs Pole.

@Harsh Prabhakar :- Need your support to provide a minimum 21 Mtrs AGL.
...
9888018075`,
  ...
  {
    id: 'E004',
    from: 'harsh.prabhakar@vodafoneidea.com',
    sender: 'Harsh Prabhaakar',
    operator: 'BSNL',
    subject: 'Relocation Proposal – Global ID 454828 (VIL ID INPB003972)',
    time: '2026-05-27 09:30',
    priority: 'high',
    unread: true,
    body: `Dear Lokesh

Request you to consider below option for relocation as existing site is on threat and will shut down by LL on 25th May 2026.

| Global ID | Short Zone / Area | Site Name | Existing OPCO | VIL ID | JIO ID | Option priority | Acquirable Lat. | Acquirable Long. | Acquirable Tower Type | Bldg Ht (Mtrs) | Tower / Pole (Mtrs) | Total AGL | Acquired area | Relocation Remarks |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 454828 | GP | KTRASHERSNGHPOL | VIL | "INPB003972" | #N/A | P2 | 31.627088 | 74.873532 | RTP | 8 | 9 | 17 | 300 sqft | Site owner has expired, legal heir and sold his property to owner not interested for tower and want to remove tower. Termination notice PROPOSED SITE IS HAVING AC AVAILABILITY ONLY BETWEEN 9 AM - 7 PM |
...
Harsh Prabhaakar`,
  ...
  {
    id: 'E005',
    from: 'rjio.north@jio.com',
    sender: 'Jio Sales Operations',
    operator: 'Jio',
    subject: 'SO Issuance – Bulk 145 Sites Feasibility & Priority RFI',
    time: '2026-05-27 09:12',
    priority: 'high',
    unread: true,
    body: `Dear Anuj Ji,
Pl consider this mail as SO issuance of below 145 sites as per feasibility received.
Kindly provide RFI as per mentioned priority.
84 sites are in Priority 1 and 61 sites are in Priority 2 for RFI.

| Rjio SAP ID | ATC ID | Global ID | Site wise sector count | Required Azimuth | Antenna height | Required no of MW | MW Dia | MW height | RF Antenna Massive MIMO | RRU | Additional DC Power - 48Volt | Additional MCBs for DC Power Tapping | RFI priority |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| I-UW-AGRA-ENB-A001 | UPW/AG/AT/10476 | 524888 | 3 sector | 0/130/210 | 22/22/22 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-AGRA-ENB-A006 | UPW/AG/AT/10321 | 523622 | 3 sector | 10/110/200 | 33/33/33 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-AGRA-ENB-A031 | UPW/AG/AT/10402 | 524302 | 3 sector | 340/140/280 | 23/23/23 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-AGRA-ENB-A034 | UPW/AG/TN/14139 | 540903 | 3 sector | 40/200/320 | 26/26/26 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-ALGR-ENB-V014 | UPW/AL/TT/13756 | 540520 | 3 sector | 40/130/290 | 27/27/27 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-HPUR-ENB-V004 | UPW/GH/ID/12889 | 539654 | 3 sector | 90/240/350 | 24/24/24 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-MDBD-ENB-A010 | UPW/MO/TN/14221 | 540984 | 3 sector | 30/140/250 | 23/23/23 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-MRUT-ENB-V013 | UPW/ME/TT/13742 | 540506 | 3 sector | 30/210/300 | 33/33/33 | | | | 3 | 2 | 2.5KW | 2x63A | P1 |
| I-UW-SRPR-ENB-A014 | UPW/SA/TT/14612 | 571213 | 3 sector | 20/210/310 | 26/26/26 | 1 | 0.6 | 38 | 3 | 2 | 2.5KW | 2x63A | P2 |

Best Regards,
Jio NOC`,
    extracted: {
      soNumber: { val: 'JIO-SO-2026-6612', conf: 99 },
      siteId: { val: 'GJ-AHM-0312', conf: 100 },
      circle: { val: 'Gujarat – Ahmedabad', conf: 97 },
      operator: { val: 'Jio', conf: 99 },
      tenantInfo: { val: '3-tenant (Jio + Airtel + Vi)', conf: 96 },
      btsType: { val: 'Nokia AirScale 5G', conf: 95 },
      plannedGoLive: { val: '2026-06-15', conf: 98 },
      slaClass: { val: 'P2 – 8 Hours', conf: 97 },
      requestType: { val: 'SO Ingest', conf: 99 }
    },
    srType: 'SO'
...
function navigateTo(view) {
  ...
  const breadcrumbs = {
    ...
    'agent-status': 'AI Agent Status Hub'
  };
  ...
  if (view === 'agent-status') {
    if (typeof resetSimulationStateToDefault === 'function') {
      resetSimulationStateToDefault();
    }
  }
}
...
function renderKanban() {
  ...
  if (srViewStyle === 'grid') {
    ...
    tbody.innerHTML = MOCK_SRS.map(sr => {
      ...
      return `
        <tr>
          <td><input type="checkbox" class="sr-row-checkbox" value="${sr.id}" ${sr.status === 'complete' ? 'disabled' : ''}></td>
          ...
          <td>
            <div style="display:flex; gap:6px;">
              ${sr.status !== 'complete' ? `<button class="btn-sm btn-primary" onclick="openSRDetailModal('${sr.id}')">Edit</button>` : ''}
...
function renderSPForm(srId) {
  ...
  const isCompleted = sp && sp.missing === 0;

  const field = (key, label, val, aiExtracted=true) => {
    let finalVal = val;
    if (isCompleted && (!val || val === '')) finalVal = 'N/A';
    return `
    <div class="form-group">
      <label class="form-label">
        ${label}
        ${aiExtracted && finalVal ? `<span class="ai-tag">AI</span>` : ''}
        ${(!finalVal && sp && sp.missing > 0) ? `<span class="missing-tag">MISSING</span>` : ''}
      </label>
      <input class="form-input sp-form-field ${(finalVal || isCompleted) ? 'ai-filled' : 'missing'}" type="text" value="${finalVal || ''}" placeholder="${(finalVal || isCompleted) ? '' : 'Required – send RFI'}" disabled />
    </div>`;
  };

  const selectField = (key, label, val, options) => {
    let finalVal = val;
    if (isCompleted && (!val || val === '')) finalVal = options[0] || 'N/A';
    return `
    <div class="form-group">
      <label class="form-label">${label} ${finalVal ? '<span class="ai-tag">AI</span>' : (!isCompleted) ? '<span class="missing-tag">MISSING</span>' : ''}</label>
      <select class="form-select sp-form-field" disabled>
        <option value="${finalVal}">${finalVal || '-- Select --'}</option>
          ...
          <div class="sp-form-content" style="padding:0">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
              ...
              <div style="display:flex; gap:12px; align-items:center;">
                <button class="btn-sm btn-primary" onclick="toggleSPFormEdit()">Edit Form</button>
...
function renderSLAList(filterStatus = 'all', filterOperator = 'all') {
  ...
  const dashTotal = document.getElementById('sla-dash-total');
  const dashGreen = document.getElementById('sla-dash-green');
  const dashAmber = document.getElementById('sla-dash-amber');
  const dashRed = document.getElementById('sla-dash-red');
  if (dashTotal) {
    dashTotal.textContent = data.length;
    dashGreen.textContent = data.filter(d => d.rag === 'green').length;
    dashAmber.textContent = data.filter(d => d.rag === 'amber').length;
    dashRed.textContent = data.filter(d => d.rag === 'red').length;
  }

  // Update Milestone Stage Distribution
  const stageCounts = { 'SR': 0, 'SP': 0, 'SO': 0, 'RFI': 0, 'Site on Air': 0 };
  data.forEach(sr => {
    const activeMilestone = sr.milestones.find(m => m.status !== 'done');
    if (activeMilestone && stageCounts[activeMilestone.name] !== undefined) {
      stageCounts[activeMilestone.name]++;
    } else {
      stageCounts['Site on Air']++;
    }
  });

  const dashSR = document.getElementById('sla-dash-sr');
  if (dashSR) {
    dashSR.textContent = stageCounts['SR'];
    document.getElementById('sla-dash-sp').textContent = stageCounts['SP'];
    document.getElementById('sla-dash-so').textContent = stageCounts['SO'];
    document.getElementById('sla-dash-rfi').textContent = stageCounts['RFI'];
    document.getElementById('sla-dash-soa').textContent = stageCounts['Site on Air'];
  }
...
function showAIOverlay(msg, callback) {
  ...
  const badge   = document.getElementById('ai-overlay-agent-badge');
  const consoleEl = document.getElementById('ai-agent-trace-console');
  
  if (!overlay || !msgEl || !fill || !badge || !consoleEl) {
  ...
  // Set up custom logs and agent handoffs based on which process is running
  let steps = [];
  if (msg.toLowerCase().includes('unread') || msg.toLowerCase().includes('email')) {
    steps = [
      { prog: 5,  agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[SECURITY] Scanning email stream via Security Engine...' },
      { prog: 15, agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[SECURITY] Anti-malware & malicious content check: PASS.' },
      { prog: 25, agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[ROUTING] Input identified as MNO shared mailbox email. Routing to Extraction Agent...' },
      { prog: 40, agent: 'Extraction Agent', color: '#3b82f6', text: '[EXTRACTION] Named Entity Recognition (NER) model initialized...' },
      { prog: 55, agent: 'Extraction Agent', color: '#3b82f6', text: '[EXTRACTION] Successfully extracted Site No, Lat/Long, Tower height & Antenna counts.' },
      { prog: 70, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Initiating data validation rules against Altius Cube Site Master...' },
      { prog: 85, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Formatting site specifications & syncing with Databricks memory store.' },
      { prog: 95, agent: 'SLA Agent', color: '#f59e0b', text: '[SLA] Standard milestones registered in SLA Milestone Tracker.' }
    ];
  } else if (msg.toLowerCase().includes('plan') || msg.toLowerCase().includes('sp')) {
    steps = [
      { prog: 5,  agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[ROUTING] Site acquisition cost estimates received. Routing to Sales AI Agent...' },
      { prog: 20, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Initiating automated validation rules for SP proposal approval...' },
      { prog: 35, agent: 'Sales Proposal Skill', color: '#ec4899', text: '[SP SKILL] Formulating Service Plan parameters in defined structure...' },
      { prog: 55, agent: 'Sales Proposal Skill', color: '#ec4899', text: '[SP SKILL] Mapping power source, earthing type, and RoW references...' },
      { prog: 70, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Handover approved. Generating Service Order (SO) in Altius Cube database...' },
      { prog: 85, agent: 'SLA Agent', color: '#f59e0b', text: '[SLA] Updating Sales Proposal stage milestones via Automated API...' },
      { prog: 95, agent: 'Notification Engine', color: '#06b6d4', text: '[NOTIF] Sending WhatsApp & MS Teams alerts to Circle Field operations.' }
    ];
  } else if (msg.toLowerCase().includes('handover') || msg.toLowerCase().includes('rfi')) {
    steps = [
      { prog: 5,  agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[ROUTING] Details of RFI milestone movement received. Initiating handover audits...' },
      { prog: 20, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Validating physical checklist & structural safety certificates...' },
      { prog: 40, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] YOLOv8 computer vision model scanning uploaded tower physical assets...' },
      { prog: 60, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Grid connection and EB energization verification: OK.' },
      { prog: 75, agent: 'SLA Agent', color: '#f59e0b', text: '[SLA] Timeline drift calculation complete. SLA milestone marked: DONE.' },
      { prog: 90, agent: 'Notification Engine', color: '#06b6d4', text: '[NOTIF] Operator equipment mounting sequence triggered. Dispatched alerts.' }
    ];
  } else {
    // General Ingestion or other cases
    steps = [
      { prog: 5,  agent: 'Unified Orchestration Agent', color: '#8b5cf6', text: '[ROUTING] New action trigger received. Ingesting transaction...' },
      { prog: 25, agent: 'Sales AI Agent', color: '#10b981', text: '[SALES] Performing complete sales cycle data validation...' },
      { prog: 50, agent: 'Sales Proposal Skill', color: '#ec4899', text: '[SP SKILL] Checking Altius Cube site master records...' },
      { prog: 75, agent: 'SLA Agent', color: '#f59e0b', text: '[SLA] Standardizing chronological threats on active tracker...' },
      { prog: 95, agent: 'Notification Engine', color: '#06b6d4', text: '[NOTIF] Dispatched team broadcats and push alerts.' }
    ];
  }

  // Clear console
  consoleEl.innerHTML = `<div style="color: #6366f1; font-weight: bold; font-family: var(--font-mono);">[SYSTEM] AI Agent Orchestration Initialized...</div>`;
  
  const timer = setInterval(() => {
    prog += Math.random() * 10 + 2;
    
    // Check if we hit any steps
    steps.forEach(step => {
      if (prog >= step.prog && !logs.includes(step.text)) {
        logs.push(step.text);
        ...
        div.innerHTML = `<span style="color: ${step.color}; font-weight: bold;">[${step.agent.split(' ')[0].toUpperCase()}]</span> <span style="color:#ffffff">${step.text}</span>`;
        ...
        badge.style.boxShadow = `0 2px 6px ${step.color}40`;
      }
    });
    ...
    if (prog >= 100) {
      ...
      // Final success trace log
      const div = document.createElement('div');
      div.style.marginTop = '6px';
      div.style.color = '#10b981';
      div.style.fontWeight = 'bold';
      div.style.fontFamily = 'var(--font-mono)';
      div.textContent = '[SUCCESS] AI Agents completed pipeline execution! Handing off to human-in-the-loop.';
      consoleEl.appendChild(div);
      consoleEl.scrollTop = consoleEl.scrollHeight;
...
let BIHAR_EMAILS = [
  {
    id: 'E001',
    from: 'joint-planning@bihar-ops.in',
    sender: 'Bihar Joint Planning Group',
    operator: 'Jio',
    subject: 'Urgent Pending 420 Upgrade Sites RFIP Sign-Off Request',
    time: '2026-05-27 11:15',
    priority: 'high',
    unread: true,
    body: `Dear Sir,
Request you to please provide the below pending 420 upgrade sites RFIB sign off urgently, as pending since long in Bihar Circle.
...
Best Regards,
Bihar Operations Planning Group
Patna Portal Team`,
    extracted: {
  ...
  {
    id: 'E002',
    from: 'rjio.bihar@jio.com',
    sender: 'Jio Bihar Planning',
    operator: 'Airtel',
    subject: 'JIO SO Issuance – 7 Feasibility-Received Sites (SAP ID I-UW-KAIR-ENB-A002 etc.)',
    time: '2026-05-27 10:45',
    priority: 'high',
    unread: true,
    body: `Dear Anuj Ji,
Pl consider this mail as SO issuance of below 7 sites in Bihar Circle as per feasibility received.
4 Sites are on hold due to rent hike issue.
...
Best Regards,
Airtel Bihar Operations Desk`,
    extracted: {
      soNumber: { val: 'AIR-2026-89012', conf: 99 },
...
As Per Our Discussion, Our existing AMR7723 site against ATC shared relocation nominal in Bihar is ok and the team to be aligned for field survey.will be confirmed after field survey.
...
Harsh Prabhaakar`,
  ...
  {
    id: 'E005',
    from: 'rjio.bihar.ops@jio.com',
    sender: 'Jio Bihar Ops',
    operator: 'Jio',
    subject: 'SO Issuance – Bulk 145 Sites Feasibility & Priority RFI',
    time: '2026-05-27 09:12',
    priority: 'high',
    unread: true,
    body: `Dear Anuj Ji,
Pl consider this mail as SO issuance of below 145 Bihar Circle sites as per feasibility received.
Kindly provide RFI as per mentioned priority.
84 sites are in Priority 1 and 61 sites are in Priority 2 for RFI.
...
Jio Bihar NOC`,
    extracted: {
      soNumber: { val: 'JIO-SO-2026-7788', conf: 99 },
      siteId: { val: 'BR-DBG-0312', conf: 100 },
      circle: { val: 'Bihar – Darbhanga', conf: 97 },
      operator: { val: 'Jio', conf: 99 },
      tenantInfo: { val: '3-tenant (Jio + Airtel)', conf: 96 },
      btsType: { val: 'Nokia AirScale 5G', conf: 95 },
      plannedGoLive: { val: '2026-06-15', conf: 98 },
      slaClass: { val: 'P2 – 8 Hours', conf: 97 },
      requestType: { val: 'SO Ingest', conf: 99 }
...
window.selectViewScope = function(role) {
  ...
  currentUser.email = role === 'circle' ? 'sales.bihar@ai.com' : 'sales.corporate@ai.com';
  ...
  showToast(`✓ View scope set to ${role === 'circle' ? 'Bihar Circle' : 'Corporate'} Sales Ops`);
};
...
function initLogin() {
  ...
  if (logoutBtn) {
    logoutBtn.addEventListener('click', () => {
      ...
      showToast('Returned to scope selection');
    });
  }
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  initSRDetailModal();
  if (typeof initAgentStatusSimulation === 'function') {
    initAgentStatusSimulation();
  }
...
window.openSRDetailModal = function(srId) {
    ...
    if (f.value !== undefined && f.value !== null && f.value !== '' && f.value !== '—') {
      const fieldHtml = `
        <div style="background: var(--bg-input); border: 1px solid var(--border-light); padding: 12px; border-radius: var(--radius-sm); display: flex; flex-direction: column; gap: 4px; transition: all 0.2s ease;">
          <label style="font-size: 10px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px;">${f.label}</label>
          <input type="text" data-field-index="${idx}" data-field-label="${f.label}" class="sr-edit-input" style="font-size: 13px; font-weight: 600; color: var(--text-primary); font-family: var(--font-mono); background: transparent; border: none; outline: none; border-bottom: 1px solid var(--border-light); padding-bottom: 2px; width: 100%;" value="${f.value}" ${sr.status === 'complete' ? 'disabled' : ''}>
        </div>
      `;
  ...
  const saveBtn = document.getElementById('sr-modal-save-btn');
...
function resetSimulationStateToDefault() {
  const pBadge = document.getElementById('pipeline-status-badge');
  if (pBadge) {
    pBadge.textContent = 'running';
    pBadge.className = 'status-lbl pulsing';
    pBadge.style.background = 'var(--accent-light)';
    pBadge.style.color = 'var(--accent)';
    pBadge.style.border = '';
  }

  const progress = document.getElementById('agent-pipeline-progress');
  if (progress) {
    progress.style.width = '45%';
  }

  const agents = [
    { id: 'orch', state: 'COMPLETE', color: 'var(--green)', opacity: '1', border: 'var(--border)' },
    { id: 'extract', state: 'COMPLETE', color: 'var(--green)', opacity: '1', border: 'var(--border)' },
    { id: 'sales', state: 'RUNNING', color: 'var(--accent)', opacity: '1', border: '1px solid rgba(59, 130, 246, 0.25)', class: 'blinking' },
    { id: 'proposal', state: 'WAITING', color: 'var(--text-muted)', opacity: '0.7', border: 'var(--border)' },
    { id: 'sla', state: 'WAITING', color: 'var(--text-muted)', opacity: '0.7', border: 'var(--border)' }
  ];

  agents.forEach(a => {
    const card = document.getElementById(`status-card-${a.id}`);
    const badge = document.getElementById(`status-badge-${a.id}`);
    if (card) {
      card.style.opacity = a.opacity;
      card.style.border = a.border;
    }
    if (badge) {
      badge.textContent = a.state;
      badge.style.color = a.color;
      if (a.class) {
        badge.className = `status-lbl ${a.class}`;
      } else {
        badge.className = 'status-lbl';
      }
    }
  });

  const btn = document.getElementById('trigger-pipeline-sim-btn');
  if (btn) {
    btn.disabled = false;
    btn.innerHTML = `
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="5 3 19 12 5 21 5 3" fill="currentColor"/></svg>
      Run Ingestion Simulation
    `;
  }
}

function initAgentStatusSimulation() {
  const btn = document.getElementById('trigger-pipeline-sim-btn');
  if (!btn) return;
  ...
  btn.addEventListener('click', () => {
    btn.disabled = true;
    btn.innerHTML = `
      <div class="login-spinner" style="display:inline-block; width:12px; height:12px; border-width:2px; margin-right:6px;"></div>
      Simulation Running...
    `;

    // 1. Reset all cards to WAITING (0%)
    const progress = document.getElementById('agent-pipeline-progress');
    ...
    const ids = ['orch', 'extract', 'sales', 'proposal', 'sla'];
    ids.forEach(id => {
      const card = document.getElementById(`status-card-${id}`);
    ...
    // 2. Timeline steps
    const stepDuration = 1500; // 1.5s per agent

    setTimeout(() => { animateAgentStep('orch', 10, 'RUNNING'); }, 200);
    setTimeout(() => { completeAgentStep('orch', 20); }, stepDuration);

    setTimeout(() => { animateAgentStep('extract', 30, 'RUNNING'); }, stepDuration + 200);
    setTimeout(() => { completeAgentStep('extract', 40); }, stepDuration * 2);

    setTimeout(() => { animateAgentStep('sales', 50, 'RUNNING'); }, (stepDuration * 2) + 200);
    setTimeout(() => { completeAgentStep('sales', 60); }, stepDuration * 3);

    setTimeout(() => { animateAgentStep('proposal', 70, 'RUNNING'); }, (stepDuration * 3) + 200);
    setTimeout(() => { completeAgentStep('proposal', 80); }, stepDuration * 4);

    setTimeout(() => { animateAgentStep('sla', 90, 'RUNNING'); }, (stepDuration * 4) + 200);
    setTimeout(() => { 
      completeAgentStep('sla', 100);
      
      setTimeout(() => {
        if (pBadge) {
          pBadge.textContent = 'complete';
          pBadge.className = 'status-lbl';
          pBadge.style.background = 'var(--green-bg)';
          pBadge.style.color = 'var(--green)';
          pBadge.style.border = '1px solid rgba(34,197,94,0.3)';
        }
        showToast('✓ Ingestion simulation completed successfully! All cognitive workflows are synced.');
  ...
  function animateAgentStep(id, progressPct, statusText) {
    const progress = document.getElementById('agent-pipeline-progress');
    const card = document.getElementById(`status-card-${id}`);
    const badge = document.getElementById(`status-badge-${id}`);
    ...
    if (badge) {
      ...
      badge.className = 'status-lbl blinking';
    }
  }

  function completeAgentStep(id, progressPct) {
    const progress = document.getElementById('agent-pipeline-progress');
    const card = document.getElementById(`status-card-${id}`);
    const badge = document.getElementById(`status-badge-${id}`);
    if (progress) progress.style.width = `${progressPct}%`;
...
window.toggleAllSRCheckboxes = function(masterCheckbox) {
  const checkboxes = document.querySelectorAll('.sr-row-checkbox:not([disabled])');
  checkboxes.forEach(cb => cb.checked = masterCheckbox.checked);
};

window.saveSRDetails = function() {
  showToast('✓ Changes saved successfully');
  document.getElementById('sr-detail-modal-backdrop').classList.remove('open');
};

window.ingestMultipleSRs = function() {
  const checkboxes = document.querySelectorAll('.sr-row-checkbox:checked');
  if (checkboxes.length === 0) {
    showToast('Please select at least one SR to ingest.');
    return;
  }
  
  const srIds = Array.from(checkboxes).map(cb => cb.value);
  
  showAIOverlay(`Autonomous Ingestion: Batch processing ${srIds.length} SRs...`, () => {
    let ingestedCount = 0;
    srIds.forEach(id => {
      const sr = MOCK_SRS.find(s => s.id === id);
      if (sr && sr.status !== 'complete') {
        if (sr.status === 'new') sr.status = 'in-progress';
        else if (sr.status === 'in-progress') sr.status = 'pending-info';
        else if (sr.status === 'pending-info') sr.status = 'complete';
        ingestedCount++;
      }
    });
    
    // Clear checkboxes
    document.querySelectorAll('.sr-row-checkbox').forEach(cb => cb.checked = false);
    const master = document.getElementById('selectAllSRs');
    ...
    showToast(`✓ Batch Ingestion completed: ${ingestedCount} SRs advanced.`);
  });
};

window.toggleSPFormEdit = function() {
  const inputs = document.querySelectorAll('.sp-form-field');
  let isEdit = false;
  inputs.forEach(i => {
  ...
  showToast(isEdit ? 'Form is now editable' : 'Form locked');
};
